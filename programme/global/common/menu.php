<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <!-- <a class="dropdown-item" href="../../2-moyen/MoyenExo1/exo1.php">exo1</a> -->
                <?php for ($i = 1; $i <= 8; $i++): ?>
                <a class="dropdown-item" href="../../2-moyen/MoyenExo<?=$i; ?>/index.php">moyen<?=$i; ?></a>
            <?php endfor; ?>
            </div>
        </li>
        <li class="nav-item dropdown">
        ...
        <li class="nav-item">
            <a class="nav-link" href="../../4-cas pratique/2-Catalogue/index.php">Catalogue </span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="../../4-cas pratique/3-Animaux/index.php">Animaux </span></a>
        </li>
    </ul>
    </div>
</nav>